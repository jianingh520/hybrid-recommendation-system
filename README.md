...
The final prediction blends both approaches to leverage the strengths of collaborative filtering and feature-based learning.
...
Several cross features are added to capture user-business interactions:
...
The model-based component uses an XGBoost regression model trained on engineered user, business, and interaction features. This model captures **non-linear relationships between users and businesses** that collaborative filtering alone cannot model.
